                        ...
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                 <?php 
                                    ...
                                    $result = mysqli_query($bdd, "SELECT tblorders.OrderDate , tblorders.ShipCountry, tblproducts.ProductName, SUM(tblorderdetails.Quantity) AS Quantity
                                        FROM tblorders JOIN `tblorderdetails`, tblproducts 
